...
class PostScreen extends StatefulWidget {
  ...
  String btnText;
  String successText;
  PostScreen({Key? key,required this.title ,required this.loadingText, required this.btnText ,required this.successText}) : super(key: key);
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: ElevatedButton(onPressed: ()async{
                            ...
                            quantityError=false;
                            setState(() {});
                            CustomDialog().show(text: widget.loadingText,context: context);
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(widget.successText)));
