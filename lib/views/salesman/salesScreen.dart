...
class _SalesScreenState extends State<SalesScreen> {
  ...
  void loadData()async{
    ...
    localData=decoded.map((e) => Product.fromJson(e)).toList();
  }
                      ...
                      child: Container(
                        height: 50.0,
                          ...
                          child: ElevatedButton(onPressed: ()async{
                            ...
                            quantityError=false;
                            setState(() {});
                            CustomDialog().show(text: "Updating Sales...",context: context);
                          ...
                          }, child: Text("Post Sales",style: TextStyle(fontWeight: FontWeight.bold),))),
                    ),
                  ],
                ),
              ),
